				...
				<div className='heartbeat'>
					<a href='mailto:aksharmeetsingh21@gmail.com'>
						<p className='aksharmeet'>
							...
							<img src='https://uploads-ssl.webflow.com/5d0f20ee6c004646f3c81f02/615bf8db0a1498233ce772d6_arrow-01.svg' alt='mail arrow' />
						</p>
					</a>
				</div>
			</Intro>
				...
				<Project>
					<div className='bg-red'>
						<a href='https://sanity-blog-vercel.vercel.app/' target='_blank' rel='noreferrer'>
							<ImageWrapper>
								<img className='tesla-desktop position1' src='./images/SanityBlog.png' alt='sanity blog' />
							</ImageWrapper>
							<p>THE BLOG</p>
						</a>
					</div>
				...
				<Project>
					<div className='bg-orange'>
						<a href='https://hopeful-murdock-c41964.netlify.app' target='_blank' rel='noreferrer'>
							<ImageWrapper>
								<img className='tesla-desktop position1' src='./images/Resturant-d.jpg' alt='resturant' />
							</ImageWrapper>
							<p>The Returant</p>
						</a>
					</div>
				...
				<Project>
					<div className='bg-red'>
						<a href='https://netflix-63936.firebaseapp.com' target='_blank' rel='noreferrer'>
							<ImageWrapper>
								<img className='tesla-desktop position1' src='./images/Netflix-d.jpg' alt='netflix' />
							</ImageWrapper>
							<p>Netflix-clone</p>
						</a>
					</div>
				...
				<Project>
					<div className='bg-red'>
						<a href='https://joyful-trifle-6e97d3.netlify.app/' target='_blank' rel='noreferrer'>
							<ImageWrapper>
								<img className='tesla-desktop position1' src='./images/mini-task.png' alt='task' />
							</ImageWrapper>
				...
				<Project>
					<div className='bg-blue'>
						<a href='https://goofy-borg-ab2033.netlify.app' target='_blank' rel='noreferrer'>
							<ImageWrapper>
								<img className='tesla-desktop' src='./images/Tesla-d.jpg' alt='tesla' />
							</ImageWrapper>
				...
				<Project>
					<div className='bg-blue'>
						<a href='https://kaleidoscopic-puffpuff-9b5100.netlify.app/' target='_blank' rel='noreferrer'>
							<ImageWrapper>
								<img className='tesla-desktop' src='./images/LazyFetch.png' alt='lazy fetch' />
							</ImageWrapper>
							<p>Lazy Fetch</p>
						</a>
					</div>
